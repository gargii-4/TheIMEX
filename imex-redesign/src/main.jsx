...
function App() {
  ...
  return <>
    ...
    <header className="container nav">
      <a href="#home" className="brand" aria-label="IMEX home"><b>IM</b><i>EX</i><span>TRADE MADE SIMPLE</span></a>
    ...
    <main id="home">
      ...
      <section className="journey" id="markets"><div className="journey-photo" /><div className="journey-panel"><p className="eyebrow light"><span /> India, connected</p><h2>From a good origin<br />to a <em>great arrival.</em></h2><p>Our world is built around the details: right source, right documentation, right route, right time.</p><a href="#contact" className="button sand">Explore our markets <b>→</b></a><div className="route"><div className="origin"><b>●</b> INDIA<br /><span>Origin</span></div><div className="route-line">✦ <span>━━━━━━</span> ✦</div><div className="destination"><b>◉</b> WORLDWIDE<br /><span>Destination</span></div></div></div></section>
